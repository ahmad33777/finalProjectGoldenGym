        ...
        <div class="col">
            <nav aria-label="breadcrumb" class="rounded-3  m-2 ">
                <ol class="breadcrumb mb-0">
                    ...
                    <li class="breadcrumb-item active"><a href="{{ route('offer.index') }}"> إدارة المنتجات المنتجات و
                            العروض</a></li>
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="card ">
                    ...
                    <form action="{{ route('offer.update', $offer->id) }}" method="POST" id="create_form"
                                ...
                                <div class="col-5">
                                    <div class="form-group text-primary">
                                        ...
                                        <input type="text" class="form-control" placeholder="ادخل عنوان العرض "
                                            name="offer_title" id="offer_title" value="{{ $offer->title }}">
                                    </div>
                                    @error('offer_title')
                                    ...
                                    <div class="form-group text-primary">
                                        ...
                                        <div class="bootstrap-datepicker">
                                            <input type="date" class="form-control timepicker" id="offer_start"
                                                name="offer_start" value="{{ $offer->offer_start }}">
                                        </div>
                                        @error('offer_start')
                                            <p style="color: red ">{{ $message }}</p>
                                        @enderror
                                    ...
                                    <div class="form-group text-primary">
                                        ...
                                        <div class="bootstrap-datepicker">
                                            <input type="date" class="form-control timepicker" id="offer_end"
                                                name="offer_end" value="{{ $offer->offer_end }}">
                                        </div>
                                        @error('offer_end')
                                            <p style="color: red ">{{ $message }}</p>
                                        @enderror
                                    ...
                                    <div class="form-group text-primary">
                                        ...
                                        <textarea class="form-control"
                                            ...
                                            name="offer_description" style="height: 100px">{{ $offer->description }}</textarea>
                                    </div>
