            ...
            <div class="col-md-12">
                <div class="card-header bg-primary text-white">
                    <div>
                        ...
                        <h3> <i class="fas fa-plus-square">&nbsp;&nbsp;</i>اضافة منتج جديد </h3>
                    </div>
                </div>
                <div class="card ">
                    @if ($errors->any())
                    ...
                    @endif
                    <form action="{{ route('products.store') }}" method="POST" d="create_form"
                                ...
                                <div class="col-4">
                                    ...
                                    <div class="form-group text-primary">
                                        ...
                                        <input type="number" min="0" class="form-control"
                                            ...
                                            style=" border: 1px solid #1196db" value="{{ old('price') }}">
                                    </div>
                                    @error('price')
                                        <p style="color: red ">{{ $message }}</p>
                                    @enderror
                                    ...
                                    <div class="form-group text-primary">
                                        ...
                                        <input type="number" min="0" class="form-control"
                                            ...
                                            style=" border: 1px solid #1196db" value="{{ old('quantity') }}">
                                    </div>
                                    @error('quantity')
                                        <p style="color: red ">{{ $message }}</p>
                                    @enderror
