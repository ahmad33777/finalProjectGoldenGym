        ...
        <div class="col">
            <nav aria-label="breadcrumb" class="rounded-3  m-2 ">
                <ol class="breadcrumb mb-0">
                    ...
                    <li class="breadcrumb-item active"> اضافة فئة </li>
                </ol>
            </nav>
        </div>
    </div>
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="card ">
                    ...
                    <form action="{{ route('categories.store') }}" method="POST" id="create_form">
                        @csrf
                        <div class="card-body">

                            <b>معلومات الفئة الجديدة </b>
                            <hr>
                            <div class="row">
                                <div class="col-8">
                                    <div class="form-group text-primary">
                                        <b style="color: red">*</b> <label for="name" style="font-weight: 900">أسم
                                            الفئة</label>
                                        <input type="test" class="form-control" placeholder="ادخل الأسم " name="category_name"
                                            id="category_name" style="border-radius:10px ;border: 1px solid #1196db"
