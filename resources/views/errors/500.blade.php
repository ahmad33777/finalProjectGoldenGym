...
@section('content')
		...
		<div class="main-error-wrapper  page page-h ">
			...
			<h2>لسوء الحظ . الصفحة التي تبحث عنها غير موجودة</h2>

			<h6>ربما أخطأت في كتابة العنوان أو ربما تم نقل الصفحة</h6><a class="btn btn-outline-danger" href="{{ route('home') }}">العودة إلى  الصفحة الرئيسية</a>
		</div>
		<!-- /Main-error-wrapper -->
@endsection
@section('js')
